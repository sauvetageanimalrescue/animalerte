...
export default async function PageReseaux({
  params,
}: PageProps<"/[locale]/fonctions/images-reseaux">) {
  const { locale } = await params;
  setRequestLocale(locale);
  const t = await getTranslations("pageReseaux");
